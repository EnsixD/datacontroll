...
export const generateSQLQueries = async (schema: DatabaseSchema): Promise<string> => {
  const prompt = `
...
export const generateDocumentation = async (schema: DatabaseSchema): Promise<string> => {
  const prompt = `
